...
public class InspectionService {
    ...
    public BaseResponse postInspectAndStartFittingApp(@Valid PostInspectionReq inspectionReq, Integer mapId) {
        ...
        // inspection 생성
        InspectionEntity inspectionEntity = InspectionEntity.builder()
                .mapGroupEntity(mapGroupEntity)
                .name(inspectionReq.getName())
                .date(LocalDate.parse(inspectionReq.getRegdate()))
                .distance(inspectionReq.getDistance())
                .build();
    ...
    public BaseResponse getFittingGroupById(Integer fittingId, Integer inspectionId) {
        return new BaseResponse(ErrorCode.SUCCESS,inspectionRepository.findByIdAndFittingId(inspectionId,fittingId));
    }
    ...
    public BaseResponse postFittingGroups(@Valid PostFittingsReq postFittingsReq, Integer inspectionId) {
        ...
        FittingGroupEntity fittingGroupEntity = FittingGroupEntity.builder()
