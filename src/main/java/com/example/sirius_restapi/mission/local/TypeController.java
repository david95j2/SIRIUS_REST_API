...
public class TypeController {
    ...
    @GetMapping("api/report/maps/inspections/fittings/missions/waypoints/{waypoint_id}/types")
    public BaseResponse getTypes(@PathVariable Integer waypoint_id) {
        return typeService.getTypes(waypoint_id);
    }

    @GetMapping("api/report/maps/inspections/fittings/missions/waypoints/{waypoint_id}/types/{type_id}")
    ...
    @PostMapping("api/report/maps/inspections/fittings/missions/waypoints/{waypoint_id}/types")
    ...
    @PatchMapping("api/report/maps/inspections/fittings/missions/waypoints/{waypoint_id}/types/{type_id}")
    ...
    @DeleteMapping("api/report/maps/inspections/fittings/missions/waypoints/{waypoint_id}/types/{type_id}")
