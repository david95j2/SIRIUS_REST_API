...
import com.example.sirius_restapi.mission.local.domain.PatchLocalDroneRes;
...
public class LocalDroneService {
    ...
    public BaseResponse postLocalDrones(PostLocalMissionReq postLocalMissionReq, Integer missionId) {
        ...
        LocalDroneEntity localDroneEntity = LocalDroneEntity.from(postLocalMissionReq, localMissionEntity);
